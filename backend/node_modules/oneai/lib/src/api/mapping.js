...
function buildRequest(input, skills, includeText, multilingual) {
    ...
    return JSON.stringify(__assign(__assign({}, (includeText && { input: fixedInput.text })), { input_type: fixedInput.type, output_type: 'json', encoding: fixedInput.encoding, content_type: fixedInput.contentType, multilingual: multilingual, steps: skills.map(function (skill) { return ({
            skill: skill.apiName,
