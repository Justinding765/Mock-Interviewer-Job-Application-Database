            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        urlParams = (0, mapping_1.buildClusteringQueryParams)(params);
                        /* istanbul ignore next */
                        return [5 /*yield**/, __values(__asyncDelegator(__asyncValues(this.collection.client.getPaginated("".concat(this.collection.id, "/clusters/").concat(this.id, "/items?").concat(urlParams), 'items', function (item) { return Item.fromJSON(undefined, item); }, params === null || params === void 0 ? void 0 : params.limit, params))))];
                    case 1: 
                    /* istanbul ignore next */
                    return [4 /*yield*/, __await.apply(void 0, [_a.sent()])];
                    case 2:
